...
- **Adjacency/Linking**: a skill is acquirable only if linked to a possessed skill (e.g., *Thrust* ↔ *Slash*). All characters start at tier-0 **[Life]** (God/Eldritch have distinct origins).
